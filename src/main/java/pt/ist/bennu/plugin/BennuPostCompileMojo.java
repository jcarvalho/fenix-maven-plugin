...
public class BennuPostCompileMojo extends AbstractMojo {
	...
	try (URLClassLoader loader = augmentClassLoader(getLog(), mavenProject)) {
	    invokeInjector("pt.ist.fenixWebFramework.security.accessControl.CheckedAnnotationInjector", loader);
	    invokeInjector("pt.ist.fenixWebFramework.services.ServiceAnnotationInjector", loader);
